<template>
    <div id="tradeHisPage" class="tradeHistory">
            ...
            <div class="vx-col w-full lg:w-1/2 mt-2  lg:pr-0">
                <div class="vx-row fixRow-userStat">
                    ...
                    <div data-v-4d9758d8="" class="col-md-12 mb-2">
                        ...
                        <div class="block">
                            <span class="float-right mr-1">MUA</span>
                            <span class="green float-right">
                                {{ up_rate ? up_rate.toFixed(2) : 0 }}%
                            </span>
                            <span class="float-left ml-1">BÁN</span>
                            <span class="red float-left">
        ...
        <div class="vx-row mt-5">
            ...
            <div data-v-0850e8cd class="table-responsive tableTradeHis relative">
