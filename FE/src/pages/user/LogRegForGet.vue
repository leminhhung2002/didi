                        ...
                        <div class="regFrom white mt-0" v-if="!isSubmitReg">
                            ...
                            <div class="centerx labelx">
                                ...
                                <div class="mb-5 relative" :class="{'md-invalid': msgNickName!=''}">
                                    <vs-input class="w-full" v-validate="'required|min:3|max:20|alpha_dash'" maxlength="20" name="nickName" label="Biệt danh *" placeholder="Điền Nickname" v-model="nickName"/>
                                    <small class="md-error text-danger text-sm">
                                        {{ msgNickName }}
                                    </small>
